...
| 채널 | 어조 | 원칙 |
|------|------|------|
| Archive (에세이) | 한다체 | 짧게. 마침표. 브랜드 주어 금지. |
| Service 랜딩 (atelier/direction/project) | 합니다체 | 정확하고 건조함. 행위 주어. 수식 제거. |
| 순수 안내 (예약·가격·연락처) | 합니다체 | 수치와 사실만. 설명 없음. |

**Service 랜딩 카피 규칙**: 합니다체를 쓰되 온도를 낮춘다. 브랜드 주어 금지. 선언이 아닌 관찰. 수식어 없이 행위만 남긴다.
